...
:::note
An Openverse validator, Stakely.io, runs a [faucet](https://stakely.io/en/faucet/openverse-evm) for builders to request dust.
:::
...
Thoroughly test your smart contracts on the Openverse Testnet to ensure it operates as intended. Comprehensive tests should
...
eligible receivers of an airdrop have a look at the [Openverse Rektdrop](https://medium.com/openverse/the-openverse-rektdrop-abbe931ba823).

### Token Registration

Openverse allows for ERC-20 tokens to be used cross-chain. Once some of your tokens have been minted, you can register a token
pair through governance, which will allow users to send your tokens across chains. Head over to our Academy to learn how
to [register your ERC-20 token](https://academy.openverse.network/developers/guides/erc20-registration).

## Revenue

On Openverse, you can generate revenue, every time a user interacts with your dApp,
...
To learn about how to [register your smart contracts](https://academy.openverse.network/developers/guides/incentives-registration),
...
Make yourself heard in the Openverse community and explain what value your dApp provides.
...
Head over to the [Openverse Discord](https://discord.gg/openverse) channel get in touch with the community and contributors and
showcase your dApp on one of the next community calls. We also have a [Telegram group](https://t.me/OpenverseBuilders) for
our builders.
