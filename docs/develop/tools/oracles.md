...
Openverse partners with several oracles providers to help provide value feed services and more.
...
Openverse data and contract address can be found [here](https://docs.adrastia.io/deployments/openverse).
...
Openverse data feed can be found [here](https://adrastia.io/app/price-feeds/openverse).
...
The [Openverse](https://docs.diadata.org/documentation/oracle-documentation/deployed-contracts#openverse) Mainnet and Testnet
