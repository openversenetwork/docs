...
Connect your Keplr wallet with Openverse.
...
or another article from a [validator](https://medium.com/coinmonks/how-to-set-up-ledger-wallet-openverse-using-keplr-c438cf8c5321).
3. If you have not used Keplr before, set a **strong** password for the Keplr extension, and click **Confirm**
4. Switch to the Ethereum app on the Ledger, then select “Openverse” from the Keplr chain registry to connect the public key
...
3. Make sure you are on the `Openverse Testnet` network from the dropdown. Testnet networks will likely be towards the bottom
of the list.
...
Once you are signed in to the Keplr extension, you can connect the wallet with the Openverse network. The Openverse mainnet network
is already built into Keplr and look for the `Openverse` network by clicking on the extension and scrolling to select the network.

## Connect to Openverse Testnet

![keplr-testnet-openverse.png](/img/keplr-testnet-openverse.png)
...
EVM-based chains. Since Openverse supports EVM and Cosmos-based actions, both ENS and ICNS are supported. Users can have
