...
previous versions, specially for client encoding and signing with Ledger devices. Openverse does not
...
allows for quick reconstruction of encoded data. Openverse uses RLP to encode/decode Ethereum
