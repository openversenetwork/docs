...
Here is a list of all production-grade modules that can be used on the Openverse blockchain, along with their respective documentation:
...
- [erc20](erc20.md) - Trustless, on-chain bidirectional internal conversion of tokens
  between Openverse' EVM and Cosmos runtimes.
...
Openverse uses the following Cosmos SDK modules:
...
Openverse uses the following the IBC modules for the SDK:
