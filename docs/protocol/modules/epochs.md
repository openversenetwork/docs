...
This document specifies the internal `x/epochs` module of the Openverse Hub.
...
Other Openverse modules can then register logic to be executed at the timer ticks.
